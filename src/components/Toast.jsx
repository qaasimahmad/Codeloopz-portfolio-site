  ...
  return (
    isVisible && (
      <motion.div
        ...
        className="w-full sm:w-[350px] fixed top-5 sm:right-5 z-[200] bg-white border-[1px] border-black px-6 py-5 pr-8 after:bg-[#5c8374] after:absolute after:h-[80%] after:w-[2px] after:rounded after:left-1 after:top-[50%] after:-translate-y-[50%]"
      >
        <div className="flex gap-3">
          ...
          <div>
            <h5 className="text-black font-grotesk text-base mb-2">
              Successful
            </h5>
